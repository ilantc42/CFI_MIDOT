...
if __name__ == "__main__":
    ...
    financial_df = financial_df.sort_values(by="report_year", ascending=True).groupby(["report_year"])
    ...
    for ranked_df in ranked_dfs:
        ranked_df.to_csv(f"./results/{RANKED_FNAME}_{ranked_df['report_year'].iloc[0]}.csv", index=False)
